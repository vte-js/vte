  ...
  <nav class="navbar" :class="{ scrolled: isScrolled }">
    <div class="container">
      ...
      <div class="nav-actions">
        <button class="theme-toggle" @click="$emit('toggle-theme')" :title="isDark ? 'Light mode' : 'Dark mode'" :aria-label="isDark ? 'Switch to light mode' : 'Switch to dark mode'">
        ...
        <a href="https://github.com/vte-js/vte" class="nav-github" target="_blank" aria-label="GitHub repository">
        ...
        <button class="hamburger" @click="$emit('toggle-menu')" :class="{ open: menuOpen }" aria-label="Toggle menu">
          <span></span>
          <span></span>
          <span></span>
        </button>
