...
import { useTokenValue, useTokenStyle, useTokenMap } from "@vte/react";
...
export function Button({
  ...
  const textColor = useTokenValue("semantic.color.text") as string;
  ...
  const sizeStyles: Record<string, React.CSSProperties> = {
    ...
    medium: {
      padding: tokenStyle.padding as string,
      fontSize: "1rem",
    },
    large: {
